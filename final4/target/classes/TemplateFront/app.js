...
app.controller('ProductCtrl', function($scope, $http) {
    ...
    $scope.getCategory = function () {
        $http({
            url: 'http://127.0.0.1:8084/category',
            method: "GET",
            headers: {
    ...
    $scope.signIn = function (auth) {
        console.log(auth);
        $http({
            url: 'http://127.0.0.1:8084/signin',
            method: 'POST',
            data: {
                'login': auth.login,
    ...
    $scope.me = function () {
        $http({
            url: 'http://127.0.0.1:8084/customers/me',
            method: 'GET',
            headers: {
                "Access-Control-Allow-Origin": "*",
                "Content-Type": "application/json",
    ...
    $scope.getProductsByCategory = function (category_id) {
        $http({
            url: 'http://127.0.0.1:8084/product/cate/' + category_id,
            method: "GET",
            headers: {
                "Access-Control-Allow-Origin": "*",
                "Content-Type": "application/json"
    ...
    $scope.getProducts = function () {
        $http({
            url: 'http://127.0.0.1:8084/product',
            method: "GET",
            headers: {
                "Access-Control-Allow-Origin": "*",
                "Content-Type": "application/json"
    ...
    $scope.createOrder = function (token) {
        $http({
            url: 'http://127.0.0.1:8084/ordder',
            method: 'POST',
            headers: {
                "Access-Control-Allow-Origin": "*",
                "Content-Type": "application/json",
    ...
    $scope.createOrderItem = function (token) {
        reorganize();
        $http({
            url: 'http://127.0.0.1:8084/orderItem/create',
            method: 'POST',
            headers: {
                "Access-Control-Allow-Origin": "*",
                "Content-Type": "application/json",
    ...
    $scope.getorderLists = function (token) {
        $http({
            url: 'http://127.0.0.1:8084/orderItem/auth',
            method: "GET",
            headers: {
                "shop_id": $scope.shop.id,
                "Access-Control-Allow-Origin": "*",
